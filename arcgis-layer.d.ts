import { Field, HtmlPopupType } from "./arcgis-rest";
import { Envelope, esriGeometryType } from "./arcgis-rest-geometry";
...
export interface Layer {
    ...
    parentLayer: LayerReference;
    subLayers: LayerReference[];
    minScale: number;
    maxScale: number;
    ...
    relationships: Array<{
        ...
        relationshipTableId: number, // <attributedRelationshipClassTableId>,  //Added in 10.1. Returned only for attributed relationships
        keyFieldInRelationshipTable: string, // "<key field in AttributedRelationshipClass table that matches keyField>" //Added in 10.1. Returned only for attributed relationships
